let questionAnswers = `"What is Professor Falmea's favorite food?":
...
let array = questionAnswers.split("case ");
let tableRows = "";
for (var i = 0; i < array.length; i++) {
    let questionAnswer = array[i].split("answer = ");
    tableRows = tableRows + "<tr><td>" + questionAnswer[0].slice(1, -3) + "</td><td>" + questionAnswer[1].slice(1, -10) + "</td></tr>\n";
}